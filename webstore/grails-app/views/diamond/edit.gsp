...
<html>
	...
	<body>
		<a href="#edit-product_Diamond" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-product_Diamond" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${product_DiamondInstance?.version}" />
				<fieldset class="form">
