...
<html>
	...
	<body>
		<a href="#edit-jewellery" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-jewellery" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${jewelleryInstance?.version}" />
				<fieldset class="form">
