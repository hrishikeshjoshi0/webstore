...
<html>
	...
	<body>
		<a href="#edit-prodProductPrice" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-prodProductPrice" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${prodProductPriceInstance?.version}" />
				<fieldset class="form">
