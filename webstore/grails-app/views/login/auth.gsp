					...
					<table>
						<tr>
							<td><label for="username"><g:message
										code='spring.security.ui.login.username' default="Username" /></label></td>
							<td><input name="j_username" id="username" size="20" /></td>
						</tr>
						<tr>
							<td><label for="password"><g:message
										code='spring.security.ui.login.password' default="Password" /></label></td>
						...
						<tr>
							<td colspan='2'><s2ui:linkButton elementId='register'
									controller='register'
