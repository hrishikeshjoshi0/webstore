					...
					<div class="row">
						<div class="left product-filter">
							...
							<div id="productTypes">
								<ul>
									<li class="productTypeFilter">
										<g:link class="productTypeFilterLink" controller="gemstone" action="create">
											Add New Gemstone		
										</g:link>
									</li>
								</ul>
							...
							<div id="productTypes">
								<ul>
									<li class="productTypeFilter">
										<g:link class="productTypeFilterLink" controller="diamond" action="create">
											Add New Diamond	
										</g:link>
									</li>
								</ul>
							...
							<div id="productTypes">
								<ul>
									<li class="productTypeFilter">
										<g:link class="productTypeFilterLink" controller="jewellery" action="create">
											Add New Jewellery	
										</g:link>
									</li>
								</ul>
